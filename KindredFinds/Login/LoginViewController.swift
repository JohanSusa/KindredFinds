...
class LoginViewController: UIViewController {
    ...
    private lazy var logoImageView: UIImageView = {
        ...
        imageView.image = UIImage(systemName: "camera.fill") // Placeholder logo
        imageView.contentMode = .scaleAspectFit
        imageView.tintColor = .label // Adapts to light/dark mode
    ...
    private func setupUI() {
        ...
        // Use constants for padding for consistency
    ...
    @objc private func handleLoginTapped() {
        ...
        User.login(username: username, password: password) { [weak self] result in
            DispatchQueue.main.async { // Switch back to main thread for UI updates
